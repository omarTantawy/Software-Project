    ...
    <div class="row">
        <div class="login" align="center">
            ...
            <form method="post" action="" onsubmit="return myFunction()">
               ...
               Dependent name name: <input type="text" class="form-control" name="name" required placeholder="Enter dependent name">
                <br>
                Age : <input type="number" size="2" class="form-control" name="age" required placeholder="Enter the age of patient" >
                <br>

                Patient name:
                <select class="input-data2" name="patientId"/>
                <?php foreach ($patients as $patient) { ?>
                    <option
                       value="<?php echo $patient['patientId'] ?>"><?php echo $patient['name'] ?></option>
                <?php } ?>
                </select>
                <br>
